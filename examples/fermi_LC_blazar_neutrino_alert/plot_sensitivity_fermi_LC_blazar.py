...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "march_update_2026_03_04-11_17_42.pkl"
        ),
        help = 'Results to use')
    parser.add_argument(
        '--run',
    ...
    ts_handler = TSHandler(res, blazar_analysis, max_run=args.run)
    ...
    plt.savefig(
        figures_folder + "4LACDR3_monthly_scrambles_update_signalness",
        bbox_inches="tight",
        dpi=200
    )
    plt.savefig(
        figures_folder + "4LACDR3_monthly_scrambles_update_signalness.pdf",
        bbox_inches="tight",
        dpi=200
    )
    plt.close()
    ts_handler.extract_sens_dp(extent=0.175)
    ...
    plt.savefig(
        figures_folder + "4LACDR3_monthly_sensitivity_5sigma_update_signalness",
        bbox_inches="tight",
        dpi=200
    )
    plt.savefig(
        figures_folder + "4LACDR3_monthly_sensitivity_5sigma_update_signalness.pdf",
        bbox_inches="tight",
        dpi=200
    )
    plt.close()
