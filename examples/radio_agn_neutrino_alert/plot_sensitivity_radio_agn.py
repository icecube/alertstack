...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=(
            ...
            "february_update_2026_02_16-10_43_25.pkl"
        ),
        help = 'Results to use')
    ...
    plt.savefig(
        figures_folder + "RFC2025c_scrambles_update_signalness",
        bbox_inches="tight",
        dpi=200
    )
    plt.savefig(
        figures_folder + "RFC2025c_scrambles_update_signalness.pdf",
        bbox_inches="tight",
        dpi=200
    )
    plt.close()
    ...
    plt.savefig(
        figures_folder + "RFC2025c_sensitivity_5sigma_update_signalness",
        bbox_inches="tight",
        dpi=200
    )
    plt.savefig(
        figures_folder + "RFC2025c_sensitivity_5sigma_update_signalness.pdf",
        bbox_inches="tight",
        dpi=200
    )
    plt.close()
